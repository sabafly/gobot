...
func (_m *Thread1000Channel) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case thread1000channel.FieldAnonymousName:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.AnonymousName = new(string)
				*_m.AnonymousName = value.String
			}
		case thread1000channel.FieldChannelID:
		...
		case thread1000channel.ForeignKeys[0]:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.guild_thread1000_channels = new(snowflake.ID)
				*_m.guild_thread1000_channels = snowflake.ID(value.Int64)
			}
		default:
...
func (_m *Thread1000Channel) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryGuild queries the "guild" edge of the Thread1000Channel entity.
func (_m *Thread1000Channel) QueryGuild() *GuildQuery {
	return NewThread1000ChannelClient(_m.config).QueryGuild(_m)
}

// QueryThreads queries the "threads" edge of the Thread1000Channel entity.
func (_m *Thread1000Channel) QueryThreads() *Thread1000Query {
	return NewThread1000ChannelClient(_m.config).QueryThreads(_m)
}
...
func (_m *Thread1000Channel) Update() *Thread1000ChannelUpdateOne {
	return NewThread1000ChannelClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the Thread1000Channel entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *Thread1000Channel) Unwrap() *Thread1000Channel {
...
func (_m *Thread1000Channel) String() string {
