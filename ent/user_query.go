...
func (_q *UserQuery) QueryOwnGuilds() *GuildQuery {
...
func (_q *UserQuery) QueryGuilds() *MemberQuery {
...
func (_q *UserQuery) QueryWordSuffix() *WordSuffixQuery {
	query := (&WordSuffixClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) QueryChinchiroSessions() *ChinchiroSessionQuery {
...
func (_q *UserQuery) QueryChinchiroPlayers() *ChinchiroPlayerQuery {
...
func (_q *UserQuery) FirstID(ctx context.Context) (id snowflake.ID, err error) {
...
func (_q *UserQuery) FirstIDX(ctx context.Context) snowflake.ID {
...
func (_q *UserQuery) OnlyID(ctx context.Context) (id snowflake.ID, err error) {
	var ids []snowflake.ID
...
func (_q *UserQuery) OnlyIDX(ctx context.Context) snowflake.ID {
...
func (_q *UserQuery) IDs(ctx context.Context) (ids []snowflake.ID, err error) {
...
func (_q *UserQuery) IDsX(ctx context.Context) []snowflake.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withOwnGuilds:         _q.withOwnGuilds.Clone(),
		withGuilds:            _q.withGuilds.Clone(),
		withWordSuffix:        _q.withWordSuffix.Clone(),
		withChinchiroSessions: _q.withChinchiroSessions.Clone(),
		withChinchiroPlayers:  _q.withChinchiroPlayers.Clone(),
...
// WithOwnGuilds tells the query-builder to eager-load the nodes that are connected to
// the "own_guilds" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithOwnGuilds(opts ...func(*GuildQuery)) *UserQuery {
	query := (&GuildClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withOwnGuilds = query
	return _q
}
...
func (_q *UserQuery) WithGuilds(opts ...func(*MemberQuery)) *UserQuery {
	query := (&MemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithWordSuffix tells the query-builder to eager-load the nodes that are connected to
// the "word_suffix" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithWordSuffix(opts ...func(*WordSuffixQuery)) *UserQuery {
	query := (&WordSuffixClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withWordSuffix = query
	return _q
}
...
func (_q *UserQuery) WithChinchiroSessions(opts ...func(*ChinchiroSessionQuery)) *UserQuery {
	query := (&ChinchiroSessionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithChinchiroPlayers(opts ...func(*ChinchiroPlayerQuery)) *UserQuery {
	query := (&ChinchiroPlayerClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withChinchiroPlayers = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		_spec       = _q.querySpec()
		loadedTypes = [5]bool{
			_q.withOwnGuilds != nil,
			_q.withGuilds != nil,
			_q.withWordSuffix != nil,
			_q.withChinchiroSessions != nil,
			_q.withChinchiroPlayers != nil,
		}
	)
	...
	if query := _q.withOwnGuilds; query != nil {
		if err := _q.loadOwnGuilds(ctx, query, nodes,
			func(n *User) { n.Edges.OwnGuilds = []*Guild{} },
			func(n *User, e *Guild) { n.Edges.OwnGuilds = append(n.Edges.OwnGuilds, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withWordSuffix; query != nil {
		if err := _q.loadWordSuffix(ctx, query, nodes,
	...
	if query := _q.withChinchiroPlayers; query != nil {
		if err := _q.loadChinchiroPlayers(ctx, query, nodes,
...
func (_q *UserQuery) loadOwnGuilds(ctx context.Context, query *GuildQuery, nodes []*User, init func(*User), assign func(*User, *Guild)) error {
	...
	query.Where(predicate.Guild(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.OwnGuildsColumn), fks...))
	}))
	...
	for _, n := range neighbors {
		fk := n.user_own_guilds
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_own_guilds" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_own_guilds" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadGuilds(ctx context.Context, query *MemberQuery, nodes []*User, init func(*User), assign func(*User, *Member)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[snowflake.ID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *UserQuery) loadWordSuffix(ctx context.Context, query *WordSuffixQuery, nodes []*User, init func(*User), assign func(*User, *WordSuffix)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[snowflake.ID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.WordSuffix(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.WordSuffixColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_word_suffix
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_word_suffix" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
...
func (_q *UserQuery) loadChinchiroSessions(ctx context.Context, query *ChinchiroSessionQuery, nodes []*User, init func(*User), assign func(*User, *ChinchiroSession)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[snowflake.ID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *UserQuery) loadChinchiroPlayers(ctx context.Context, query *ChinchiroPlayerQuery, nodes []*User, init func(*User), assign func(*User, *ChinchiroPlayer)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[snowflake.ID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
