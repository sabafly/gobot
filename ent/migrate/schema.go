...
var (
	...
	GuildsColumns = []*schema.Column{
		...
		{Name: "level_up_message", Type: field.TypeString, Size: 2147483647, Default: "{user}がレベルアップしたよ！🥳\n**{before_level} レベル → {after_level} レベル**"},
		...
		{Name: "bump_message_title", Type: field.TypeString, Size: 2147483647, Default: "Bumpを検知しました"},
		{Name: "bump_message", Type: field.TypeString, Size: 2147483647, Default: "２時間後に通知します"},
		{Name: "bump_remind_message_title", Type: field.TypeString, Size: 2147483647, Default: "Bumpの時間です"},
		{Name: "bump_remind_message", Type: field.TypeString, Size: 2147483647, Default: "</bump:947088344167366698>でBumpしましょう"},
		{Name: "up_enabled", Type: field.TypeBool, Default: true},
		{Name: "up_message_title", Type: field.TypeString, Size: 2147483647, Default: "UPを検知しました"},
		{Name: "up_message", Type: field.TypeString, Size: 2147483647, Default: "１時間後に通知します"},
		{Name: "up_remind_message_title", Type: field.TypeString, Size: 2147483647, Default: "UPの時間です"},
	...
	WordSuffixesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUUID},
		{Name: "suffix", Type: field.TypeString, Size: 2147483647},
